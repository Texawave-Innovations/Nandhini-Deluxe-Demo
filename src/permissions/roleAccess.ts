...
export const ROLE_MODULE_ACCESS: Record<UserRole, string[]> = {
  ...
  OUTLET_MANAGER: ['dashboard', 'pos', 'inventory', 'recipe', 'purchase', 'hotel', 'banquet', 'hrms', 'reports', 'masters'],
  ...
  FINANCE_EXECUTIVE: ['dashboard', 'finance', 'reconciliation', 'tally', 'reports'],
  FINANCE_MANAGER: ['dashboard', 'finance', 'reconciliation', 'tally', 'vendors', 'reports', 'administration'],
